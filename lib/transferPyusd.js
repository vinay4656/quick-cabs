...
async function transferPyUSD( amount, mm) {
    ...
    const recipientAddress = "0xCEB820486AcB7BE0920C8c8a9d7336B68dcFF090";
  ...
  // Execute transfer
  const tx = await pyusdContract.transfer(recipientAddress, ethers.BigNumber.from(Number(amount).toFixed(2)*10**6));
