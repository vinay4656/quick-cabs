...
const Feature = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-24 pt-24">
      ...
      <section className="space-y-8 ">
        ...
        <div className="grid md:grid-cols-3 gap-8 ">
          <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-lg transition-shadow duration-300">
