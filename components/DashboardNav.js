...
const style = {
  ...
  menuItem: `text-sm md:text-base text-black font-normal flex items-center mx-2 md:mx-4 cursor-pointer`,
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.leftMenu}>
        ...
        <div className={style.menuItem}>Orders</div>
        <div className={style.menuItem}>Transactions</div>
        <div className={style.menuItem}>Customer Support</div>
      </div>
